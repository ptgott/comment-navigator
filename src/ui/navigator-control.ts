...
export class NextButton extends NavigatorControl{
    ...
    public render(): HTMLElement{
        ...
        this.element.addEventListener('click', (ev)=>{
            ...
            this.targetThread.element.parentElement.parentElement.dispatchEvent(new MouseEvent('click'));
        })
        return this.element;
    }
    ...
    public refresh(fr: FiltrationRecord){
        ...
        this.targetThread = fr.after.elements[Math.min(fr.after.elements.length, i+1)];
    }
}
