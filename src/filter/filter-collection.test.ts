...
import { FinalCommentAuthorNameFilter, SuggestionsFilter, RegexpBodyFilter } from "./filter";
...
describe('FilterCollection', ()=>{
    ...
    test('chains filters together', ()=>{
        const threadColl = ParseBodyForThreads(document.getElementsByTagName('body')[0]);
